                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="flex-grow">
                                    <h3 className={`${embedded ? "text-lg" : "text-xl"} font-semibold text-primary mb-2 leading-tight`}>
                                        <span className="text-neutral-500 dark:text-neutral-400 mr-2">[{filteredPublications.length - index}]</span>
                                        ...
                                        {pub.authors.map((author, idx) => (
                                            <span key={idx}>
                                                ...
                                                {author.isCorresponding && (
                                                    <sup className={`ml-0 ${author.isHighlighted ? 'text-accent' : 'text-neutral-600 dark:text-neutral-400'}`} title="Corresponding author">✉</sup>
                                                )}
